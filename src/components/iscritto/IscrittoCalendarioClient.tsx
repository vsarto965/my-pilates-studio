          ...
          <div className="flex items-center gap-3">
            <div>
              ...
              <div className="text-sm text-gray-600">
                ...
                {' · '}
                <span className={cn('text-xs px-1.5 py-0.5 rounded-full font-medium', LIVELLO_COLORE[(prossimaPrenotazione.slot as any).livello])}>
                  {LIVELLO_LABEL[(prossimaPrenotazione.slot as any).livello]}
                </span>
              </div>
            </div>
            <button
